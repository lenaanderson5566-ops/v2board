...
class UserService
{
    ...
    private function ensureBaseCurrencyWallet(int $userId, CurrencyRateService $currencyRateService): void
    {
        ...
        $baseWallet = $wallets->firstWhere('currency', $baseCurrency);
        if ($baseWallet) {
            return;
        }
    ...
    public function getUserWalletsRaw(int $userId): array
    {
        ...
        $this->ensureBaseCurrencyWallet($userId, $currencyRateService);
