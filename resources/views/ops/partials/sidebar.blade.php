<aside class="sidebar">
        ...
        <div class="menu-section" data-group="risk">
            ...
            <div class="menu-list">
                ...
                <button class="menu-btn" data-section="risk" onclick="fetchIpBlacklists(this)">IP黑名单配置</button>
                <button class="menu-btn" data-section="risk" onclick="fetchUaBlacklists(this)">UA黑名单配置</button>
            </div>
        </div>
